...
class AssetRepository extends Repository
{
	 ...
	 */
	public function getAsset($entityIdOrIds)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function getAssetBy($field, $value)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function getAssetsByIds(array $entityIds = null)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function getAssets(array $scopes = [])
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function paginateAssets(array $scopes, $limit = 15, $withTrashed = false)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function createAsset(array $entityData)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function updateAsset($entityId, array $entityData)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function deleteAsset($entityId)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function deleteAssets(array $entityIds)
	{
		$deletedPosts = [];
