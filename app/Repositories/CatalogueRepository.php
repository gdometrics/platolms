...
class CatalogueRepository extends Repository
{
	...
	public function __construct()
	{
		...
		$this->model = 'App\Models\Catalogue';
	}
	 ...
	 */
	public function getCatalogue($entityIdOrIds)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function getCatalogueBy($field, $value)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function getCataloguesByIds(array $entityIds = null)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function getCatalogues(array $scopes = [])
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function paginateCatalogues(array $scopes, $limit = 15, $withTrashed = false)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function createCatalogue(array $entityData)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function updateCatalogue($entityId, array $entityData)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function deleteCatalogue($entityId)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function deleteCatalogues(array $entityIds)
	{
		$deletedPosts = [];
