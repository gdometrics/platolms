...
class SyllabusRepository extends Repository
{
	...
	{
		$this->table = 'syllabi';
		$this->model = 'App\Models\Syllabus';
	}
	 ...
	 */
	public function getSyllabus($entityIdOrIds)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function getSyllabusBy($field, $value)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function getSyllabussByIds(array $entityIds = null)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function getSyllabuss(array $scopes = [])
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function paginateSyllabuss(array $scopes, $limit = 15, $withTrashed = false)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function createSyllabus(array $entityData)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function updateSyllabus($entityId, array $entityData)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function deleteSyllabus($entityId)
	{
	 ...
	 * @return \Illuminate\Contracts\Validation\Validator
	 */
	public function deleteSyllabuss(array $entityIds)
	{
		$deletedPosts = [];
